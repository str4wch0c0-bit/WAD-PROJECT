    ...
    <div class="nav-inner">
        ...
        <div class="nav-links">
            <a href="/event_ticketing/public/index.php?controller=event&action=index"
               class="nav-link <?= (($_GET['controller'] ?? 'event') === 'event') ? 'active' : '' ?>">Beranda</a>

            <?php if (isset($_SESSION['user_id'])): ?>
                <a href="/event_ticketing/public/index.php?controller=ticket&action=index"
                   class="nav-link <?= (($_GET['controller'] ?? '') === 'ticket') ? 'active' : '' ?>">Tiket Saya</a>
            <?php endif; ?>

            <?php if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']): ?>
                <div class="nav-sep"></div>
                <a href="/event_ticketing/public/index.php?controller=event&action=create"
                   class="nav-link">+ Acara <span class="nav-badge">Admin</span></a>
                <a href="/event_ticketing/public/index.php?controller=user&action=index"
                   class="nav-link <?= (($_GET['controller'] ?? '') === 'user') ? 'active' : '' ?>">Users <span class="nav-badge">Admin</span></a>
                <a href="/event_ticketing/public/index.php?controller=payment&action=index"
                   class="nav-link <?= (($_GET['controller'] ?? '') === 'payment') ? 'active' : '' ?>">Pembayaran <span class="nav-badge">Admin</span></a>
            <?php endif; ?>
        </div>
